    ...
    try {
      ...
      await firestore()
        ...
        .set({
          fullName,
          email,
          photoUrl: `https://png.pngtree.com/background/20230528/original/pngtree-mans-side-profile-in-front-of-a-black-background-picture-image_2771953.jpg`,
          createdAt: new Date(),
        })
        .then(() => {
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={[styles.container, {paddingVertical}]}>
          <View>
            ...
            Tidak ada kata terlambat untuk bergabung dengan OlahragaKu, kami menyambut Anda!
            </Text>
